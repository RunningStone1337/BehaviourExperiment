...
namespace Training
{
    ...
    public class TrainingConfigurator : EnvironmentInfoSource
    {
        ...
        [SerializeField] private SchoolAgentBase trainedAgent;
        ...
        [SerializeField] private SchoolAgentBase trainSourceAgent;
        ...
        private void CreateNewRelations(Relationships relationsType, SchoolAgentBase trainedAgent, SchoolAgentBase trainSourceAgent)
        {
        ...
        private void CreateRandomCharacterTraits(SchoolAgentBase agent)
        {
        ...
        private void ResetAgent(SchoolAgentBase agentToReset, SchoolAgentBase secondAgent, PupilRawData agentManualData, SettingsType agentSettingsType, SettingsType relationsSettingsType, bool log = false)
        {
        ...
        private void ResetAgentGlobalEvent(SchoolAgentBase trainedAgent, SettingsType eventSettingsType, bool logEvent = false)
        {
        ...
        public override List<TemporaryEffect> TemporaryEffects => throw new NotImplementedException();
