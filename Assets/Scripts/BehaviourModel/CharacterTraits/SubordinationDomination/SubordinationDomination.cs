...
namespace BehaviourModel
{
    ...
    /// </summary>
    public abstract class SubordinationDomination : CharacterTraitBase, IComparable<SubordinationDomination>
    {
        public static bool operator <(SubordinationDomination c1, SubordinationDomination c2) =>
            Char1LessChar2<LowDomination, MiddleDomination, HighDomination, SubordinationDomination>(c1, c2);

        public static bool operator <=(SubordinationDomination c1, SubordinationDomination c2) =>
            Char1LessOrEqualChar2<LowDomination, MiddleDomination, HighDomination, SubordinationDomination>(c1, c2);

        public static bool operator >(SubordinationDomination c1, SubordinationDomination c2) =>
            Char1MoreChar2<LowDomination, MiddleDomination, HighDomination, SubordinationDomination>(c1, c2);

        public static bool operator >=(SubordinationDomination c1, SubordinationDomination c2) =>
            Char1MoreOrEqualChar2<LowDomination, MiddleDomination, HighDomination, SubordinationDomination>(c1, c2);
