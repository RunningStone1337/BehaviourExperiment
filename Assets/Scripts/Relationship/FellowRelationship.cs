namespace BehaviourModel
{
    ...
    /// </summary>
    public class FellowRelationship<TReaction, TFeature, TState> : PositiveRelationshipBase<TReaction, TFeature, TState>
         ...
         where TFeature : IFeature where TState : IState
    {
        ...
        public FellowRelationship(AgentBase<TReaction, TFeature, TState> thisAgent, AgentBase<TReaction, TFeature, TState> secondAgent)
