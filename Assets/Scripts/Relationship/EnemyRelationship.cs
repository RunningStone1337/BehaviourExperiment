...
{
    /// <summary>
    /// ¬раг - отношени€ у нас не сложились и вр€д ли это изменитс€.
    /// </summary>
    public class EnemyRelationship<TReaction, TFeature, TState> : FoeRelationship<TReaction, TFeature, TState>
...

    {
        ...
        public EnemyRelationship(AgentBase<TReaction, TFeature, TState> thisAgent, AgentBase<TReaction, TFeature, TState> secondAgent) : base(thisAgent, secondAgent)
        {
            relationship = RelationshipType.Enemy;
        }
        public override string ToString()
        {
            return "¬ражеские отношени€.";
        }
