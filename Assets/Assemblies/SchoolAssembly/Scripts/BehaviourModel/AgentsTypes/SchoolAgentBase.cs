...
namespace BehaviourModel
{
        ...
        where TAgent : SchoolAgentBase<TAgent>
    {
            ...
            where TInitiator: SchoolAgentBase<TInitiator>
        {
            ...
            {
                //throw new System.Exception($"ƒл€ спича {speechToReact} не было ответного спича у агента {this}");
