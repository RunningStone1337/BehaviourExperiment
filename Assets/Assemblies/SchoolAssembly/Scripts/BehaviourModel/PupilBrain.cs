...
namespace BehaviourModel
{
        ...
        ICanReactOnPhenomenon<LessonEvent, ReactionBase>
    {
        ...
        public bool HasReactionsOnPhenom(PupilAgent reason, out List<ReactionBase> reactions)
        {
            ...
            reactions = ThisAgent.GetReactionsOnPhenom<PupilAgent>(relations);
            return true;
        }

        public bool HasReactionsOnPhenom(TeacherAgent reason, out List<ReactionBase> reaction)
        {
            throw new NotImplementedException();
        }

        public bool HasReactionsOnPhenom(PlacedInterier reason, out List<ReactionBase> reaction)
        {
            throw new NotImplementedException();
        }

        public bool HasReactionsOnPhenom(BreakEvent reason, out List<ReactionBase> reaction)
        {
            throw new NotImplementedException();
        }

        public bool HasReactionsOnPhenom(LessonEvent reason, out List<ReactionBase> reaction)
        {
            throw new NotImplementedException();
        }

        protected override void MakeReaction(ReactionBase reactions)
        {
            throw new NotImplementedException();
        }
        #endregion
