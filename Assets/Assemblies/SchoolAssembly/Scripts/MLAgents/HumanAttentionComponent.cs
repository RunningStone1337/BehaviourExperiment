...
//    /// <summary>
    ...
    //    private void HandleApproximateReactionTo(CharacterTraitBase<TAgent, TReaction, TFeature, TState, TSensor> charTrat, GlobalEvent ev, ref int positiveReactions, ref int negativeReactions, ref int neutralReactions)
    //    {
    ...
    //    private void HandleApproximateReactionTo(CharacterTraitBase<TAgent, TReaction, TFeature, TState, TSensor> charTrat, RelationshipBase relations, ref int positiveReactions, ref int negativeReactions, ref int neutralReactions)
    //    {
