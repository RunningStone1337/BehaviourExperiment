...
namespace BehaviourModel
{
    ...
    /// </summary>
    public class FoeRelationship<TAgent, TOtherAgent, TState/*, TReaction, TFeature, TState, TSensor*/> : 
        NegativeRelationshipBase<TAgent, TOtherAgent, TState/*, TReaction, TFeature, TState, TSensor*/>
