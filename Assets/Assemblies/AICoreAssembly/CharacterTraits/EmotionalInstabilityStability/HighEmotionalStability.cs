namespace BehaviourModel
{
    ...
    /// </summary>
    public class HighEmotionalStability<TAgent, TReaction, TFeature, TState, TSensor> : EmotionalInstabilityStability<TAgent, TReaction, TFeature, TState, TSensor>
        ...
        where TFeature : IFeature where TState : IState where TSensor : ISensor
    {
        public override void Initiate(int characterValue, TAgent agent)
        {
            ...
            ThisConcreteCharType = CharTraitTypeExtended.HighEmotionalInstabilityStability;
        }
